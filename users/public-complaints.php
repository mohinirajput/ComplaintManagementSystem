...
<html lang="en">
  <head>
    ...
    <title>CMS | Public Complaints</title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Public Complaints</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <tbody>
  <?php $query=mysqli_query($con,"select * from tblcomplaints where visibility=1");
while($row=mysqli_fetch_array($query))
{
  ?>
                              <tr>
                                  <td align="center"><?php echo htmlentities($row['subcategory']);?></td>
                                  <td align="center"><?php echo htmlentities($row['complaintDetails']);?></td>
...
<?php } ?>
                                   <td align="center">
                                   <a href="public-complaint-details.php?cid=<?php echo htmlentities($row['complaintNumber']);?>">
