...
{ 
    ...
    if(isset($_POST['submit']))
    {
      ...
      $query=mysqli_query($con,"insert into tblcomplaints(complaintNumber,userId,category,subcategory,complaintType,state,noc,complaintDetails,complaintFile,visibility,department) values('$complaintId','$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile','$visibility','$department')");
      $sql=mysqli_query($con,"select complaintNumber from tblcomplaints");
      ...
      $complainno=$cmpn;
      if($query)
        echo '<script> alert("Your complain has been successfully filled and your complaintno is  "+"'.$complaintId.'")</script>';
      else{
                      ...
                      <form class="form-horizontal style-form" method="post" name="complaint" enctype="multipart/form-data" >
                        <div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label">Category</label>
                            <div class="col-sm-4">
                              <select name="department" id="category" class="form-control" onChange="getCat(this.value);" required="">
                                <option value="">Select Category</option>
                                  ...
                                  <?php
                                   ...
                                   $sql1=mysqli_query($con,"select DepUniqueId,DepName from departments");
                                    while ($rw1=mysqli_fetch_array($sql1)) {
                                  ?>
                                  <option value="<?php echo htmlentities($rw1['DepUniqueId']);?>"><?php echo htmlentities($rw1['DepName']);?></option>
                                  <?php
                                  }
                                  ?>
                              </select>
                        ...
                        <div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label">Visibility</label>
                          <div class="col-sm-4">
                            <select name="visibility" class="form-control" required="">
                              <option default value="0">Private</option>
