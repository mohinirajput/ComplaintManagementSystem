...
$q = "SELECT * FROM state WHERE stateName='$stateName'";
$res = $con->query($q);
$rw = $res->fetch_assoc();
$state = $rw['id'];
...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',State='$state',userEmail='$email' where userEmail='".$_SESSION['login']."'");
if($query)
{
                    ...
                    <?php if($errormsg)
                      ...
                      <form class="form-horizontal style-form" method="post" name="profile" >
                        <div class="form-group">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="rollNo" required="required" value="<?php echo htmlentities($row['rollNo']);?>" class="form-control" readonly>
                          </div>
                        </div>
                        <div class="form-group">  
...
if($rw['DepUniqueId']==$row[department])
$dep = $rw['DepName'];
}
?>
<input type="text" name="department" required="required" value="<?php echo htmlentities($dep);?>" class="form-control" readonly>
