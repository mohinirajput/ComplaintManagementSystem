...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into faculty values('$facUniqueId','$facId','$fullname','$department','teacher','$email','$contactno','$password',0)");
	if($query)
	$msg="Faculty Added Successfully. Add another Faculty !";
	else
	$msg="Faculty already exit with this id!";
}
?>
...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#111">Complaint Managent System</h3>
	<hr />
		      <form class="form-login" method="post">
		        <h2 class="form-login-heading">Add Faculty</h2>
...
echo htmlentities($msg);
				...
				<input type="text" class="form-control" placeholder="faculty Id" name="facId" required="required" autofocus>
		            <br>
