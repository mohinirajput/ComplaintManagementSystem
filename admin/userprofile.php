...
?>
    ...
    <tr height="50">
      ...
      $result = mysqli_query($con,"SELECT * FROM departments WHERE DepUniqueId = '$depId'");
      $rww = $result->fetch_assoc();
      ?>
      <td><?php echo htmlentities($rww['DepName']); ?></td>
    </tr>
    <tr height="50">
    ...
    <tr height="50">
      ...
      <?php 
      $stateId = $row['State'];
      $q = "SELECT * FROM state WHERE id ='$stateId'";
      $res = $con->query($q);
      $rw = $res->fetch_assoc();
      $stateName = $rw['stateName'];
      ?>
      <td><?php echo htmlentities($stateName); ?></td>
    </tr>
    <tr height="50">
