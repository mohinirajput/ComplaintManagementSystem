								...
								?>									
										<tr>
											...
											<?php 
												...
												$res = mysqli_query($con,"SELECT DepName FROM departments WHERE DepUniqueId='$depId'");
												$rw = $res->fetch_assoc();
											?>
											<td> <?php echo htmlentities($rw['DepName']);?></td>
											...
											<a href="javascript:void(0);" onClick="popUpWindow('edit-profile.php?uid=<?php echo htmlentities($row['id']);?>');" title="Edit Details">
