...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"insert into category(id,categoryName,categoryDescription) values('$id','$category','$description')");
	$_SESSION['msg']="Category Created !!";
}

if(isset($_GET['del']))
{
	$sqll=mysqli_query($con,"delete from category where id = '".$_GET['id']."'");
